...
public interface IRemarkService {
	 ...
	 * @return
	 */
	List<List<Remarkimage>> findAllRemarkimag(List<String> remarkIdList,int cityId);
	/**
	 * 根据id查询点评分享数量
	 * @return
	 */
	 ...
	 * @return
	 */
	List<List<Remarkcomment>> findAllRemarkcomment(List<String> remarkIdList,int cityId);
	 ...
	 * @param remark
	 */
	void saveremark(Remark remark,int cityId);
	 ...
	 */
	void saveRemarkimageList(List<Remarkimage> RemarkimageList,int city);
	 ...
	 * @param remarkcomment
	 */
	void saveRemarkcomment(Remarkcomment remarkcomment,int cityId);
